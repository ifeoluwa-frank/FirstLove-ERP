                  ...
                  @forelse($upcoming_birthdays as $upcoming_birthday)
                    <div class="flex align-center justify-between mb-3">
                      <div class="flex gap-1">
                          ...
                          <div class="mt-1 mr-3">
                              <p class="text-xs font-bold">{{ $upcoming_birthday->first_name }} {{ Str::limit($upcoming_birthday->last_name, 5) }}</p>
                              <span class="text-xs text-gray-400">{{ $upcoming_birthday->bacenta->bacenta_name }}</span>
                          </div>
                      </div>
                      ...
                      <div class="flex bg-gray-300 px-3 py-2 gap-1 align-center rounded-md">
                          ...
                          <span class="text-sm mt-1">{{ \Carbon\Carbon::parse($upcoming_birthday->dob)->format('M d') }}</span>
                      </div>
                  </div>
                  @empty
                  <div class="mt-1 mr-3"> 
